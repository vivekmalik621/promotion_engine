...
insert into Product(ID,SKU,UNIT_PRICE) values (5L,'E', 50);
...
insert into Promotion(ID,COMBO_REFERENCE_ID,PRICE,QUANTITY,TYPE,SKU_MAPPING) values (3L,2L,130,1,'COMBO',3L);
insert into Promotion(ID,COMBO_REFERENCE_ID,PRICE,QUANTITY,TYPE,SKU_MAPPING) values (4L,2L,130,1,'COMBO',4L);
insert into Promotion(ID,COMBO_REFERENCE_ID,PRICE,QUANTITY,TYPE,SKU_MAPPING) values (5L,2L,130,1,'COMBO',5L);
